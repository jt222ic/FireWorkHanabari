...
/// </summary>
    ...
    public enum EnemyType { rectangle, triangle, circle,diamond, arrow,bolt,heart };
    ...
    public class Enemy
    {
        ...
        public Enemy()
        {
        //this.Type = (EnemyType)Random.Range((int)EnemyType.rectangle, (int)EnemyType.heart +1);
        this.Type = this.Type;
